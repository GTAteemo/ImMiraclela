...
PVOID get_system_module_base(const char* module_name)
{
	...
	PRTL_PROCESS_MODULES modules = (PRTL_PROCESS_MODULES)ExAllocatePoolWithTag(NonPagedPool, bytes, 0x4e554c4c); //NULL Hex
...
PVOID AllocateVirtualMemory(SIZE_T Size)
{
	...
	//DbgPrintfEx(0,0,"[+] AllocateVirtualMemory statusAlloc: %x \n", statusAlloc);
	return pMem;
}
